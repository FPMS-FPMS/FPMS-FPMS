...
# Stable ports
# =====================
D500_PORT = "/dev/serial/by-path/platform-fc880000.usb-usb-0:1.3:1.0-port0"
ESP_PORT = "/dev/serial/by-path/platform-xhci-hcd.11.auto-usb-0:1:1.0-port0"
YAHBOOM_PORT = "/dev/serial/by-path/platform-fc880000.usb-usb-0:1.2:1.0-port0"
...
# =====================
GRID_RES = 100
ROUTE_CLEARANCE = 90     # tight for 60cm wide arena — too tight for 230mm chassis
...
_p5_odom = {"x": 550.0, "y": 50.0, "theta": 0.0}
def _p5_odom_reset():
    _p5_odom.update({"x": 550.0, "y": 50.0, "theta": 0.0})
