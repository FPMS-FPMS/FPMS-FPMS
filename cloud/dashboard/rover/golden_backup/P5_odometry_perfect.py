...
# Stable ports
# =====================
D500_PORT = "/dev/serial/by-path/platform-fc8c0000.usb-usb-0:1:1.0-port0"
...
def _p5_navdrive(bot, target, timeout=55.0):
    import math as _m
    _TKMM=_m.pi*70.0/1320.0; _DRV=26; _TRN=36; _COAST=0.93; _HZ=20
    _FSTOP=120; _KPH=10
