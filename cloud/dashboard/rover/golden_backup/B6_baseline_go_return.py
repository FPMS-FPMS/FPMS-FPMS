...
PAGE = r'''
<!doctype html><html><head><meta charset="utf-8"><title>FPMS B3 FINAL</title>
<style>
...
<body><div class="top"><div><h1>FPMS B3 FINAL</h1><div class="sub">200cm × 250cm centered map • one webserver • strong lock • run M1/home</div></div><div id="clock"></div></div>
...
B6_SLOW_APPROACH_RAW = 680
B6_FINE_FORWARD_POWER = -12
B6_FINE_BACKWARD_POWER = 20
B6_FORWARD_POWER = -24
B6_BACKWARD_POWER = 30
...
if __name__ == '__main__':
    event('FPMS B3 FINAL starting', 'i')
