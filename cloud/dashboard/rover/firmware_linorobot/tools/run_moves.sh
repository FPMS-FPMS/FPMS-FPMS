...
cp /home/ubuntu/moves_main.cpp /home/ubuntu/crawl/src/main.cpp
...
echo ""
echo ">>> 5s PAUSE, THEN FWD 80cm, BACK 80cm, TURN 90 LEFT, TURN 90 RIGHT, THEN IT STOPS <<<"
python3 - <<'EOF'
import time, serial
